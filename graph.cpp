...
#define planets tmp->planets
	...
	vvi nexts_fast;
	vvi dists_line;
	int line_dist(int a, int b){
		return dists_line[a][b];
	}
	int any_dist(int fr, int to){
		return dists_any[fr][to];
	}
	int fast_dist(int fr, int to){
		return dists_any[fr][to];
	}
	int any_next(int fr, int to){
		return nexts_any[fr][to];
	}
	int fast_next(int fr, int to){
		return nexts_fast[fr][to];
	}
